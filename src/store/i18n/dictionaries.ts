...
export const ruProducts: I18nDict = {
  ...
  "products.filters.sort.manual": "По порядку (в категории)",
  ...
  "products.form.attributes": "Характеристики товара",
  "products.form.attr.key.required": "Укажите название",
  "products.form.attr.value.required": "Укажите значение",
  "products.form.attr.key.placeholder": "Название (напр. Материал)",
  "products.form.attr.value.placeholder": "Значение (напр. Металл)",
  "products.form.attr.add": "Добавить характеристику",
  "products.attributes.help.title": "Характеристики товара",
  "products.attributes.help.desc":
    "Это таблица параметров на странице товара (вкладка «Характеристики»): материал, назначение, размер и т.д. Слева — название, справа — значение. Не путать с «Опциями» варианта, которые задают выбор (размер/цвет) и цену.",
  "products.form.images": "Изображения товара",
  "products.form.videos": "Видео товара",
  "products.form.videos.tooltip": "Видео показывается на странице товара под фото.",
  "products.form.videos.upload": "Загрузить видео",
  "products.form.videos.uploaded": "Видео загружено",
  "products.form.videos.error": "Не удалось загрузить видео",
  "products.form.videos.tooBig": "Видео до 100 МБ",
  ...
  "products.variants.form.options": "Опции",
  ...
  // Section headers
  "products.section.basics": "Основное",
  "products.section.attributes": "Характеристики",
  "products.section.media": "Фото",
  "products.section.settings": "Настройки",
  "products.section.variants": "Варианты",
  // Variants block
  ...
  "products.clone.button": "Дублировать",
  "products.clone.title": "Дублировать товар?",
  "products.clone.confirm": "Создать копию товара",
  "products.clone.ok": "Дублировать",
...
export const ukProducts: I18nDict = {
  ...
  "products.filters.sort.manual": "За порядком (у категорії)",
  ...
  "products.form.attributes": "Характеристики товару",
  "products.form.attr.key.required": "Вкажіть назву",
  "products.form.attr.value.required": "Вкажіть значення",
  "products.form.attr.key.placeholder": "Назва (напр. Матеріал)",
  "products.form.attr.value.placeholder": "Значення (напр. Метал)",
  "products.form.attr.add": "Додати характеристику",
  "products.attributes.help.title": "Характеристики товару",
  "products.attributes.help.desc":
    "Це таблиця параметрів на сторінці товару (вкладка «Характеристики»): матеріал, призначення, розмір тощо. Зліва — назва, справа — значення. Не плутати з «Опціями» варіанту, які задають вибір (розмір/колір) і ціну.",
  "products.form.images": "Зображення товару",
  "products.form.videos": "Відео товару",
  "products.form.videos.tooltip": "Відео показується на сторінці товару під фото.",
  "products.form.videos.upload": "Завантажити відео",
  "products.form.videos.uploaded": "Відео завантажено",
  "products.form.videos.error": "Не вдалося завантажити відео",
  "products.form.videos.tooBig": "Відео до 100 МБ",
  ...
  "products.variants.form.options": "Опції",
  "products.variants.form.options.tooltip": "Приклад: shade:A2, size:2g",
  "products.variants.form.options.placeholder": "shade:A2, size:2g",
  "products.variants.form.apply": "Додати/Оновити варіант",
  // Section headers
  "products.section.basics": "Основне",
  "products.section.attributes": "Характеристики",
  "products.section.media": "Фото",
  "products.section.settings": "Налаштування",
  "products.section.variants": "Варіанти",
  // Variants block
  ...
  "products.clone.button": "Дублювати",
  "products.clone.title": "Дублювати товар?",
  "products.clone.confirm": "Створити копію товару",
  "products.clone.ok": "Дублювати",
...
export const ruPromoSlides: I18nDict = {
  "layout.menu.promoSlides": "Акции (слайдер)",
  "promoSlides.pageTitle": "Акционные предложения",
  "promoSlides.loadError": "Не удалось загрузить слайды",
  "promoSlides.actions.create": "Добавить слайд",
  "promoSlides.save.success": "Слайд сохранён",
  "promoSlides.save.error": "Не удалось сохранить слайд",
  "promoSlides.delete.success": "Слайд удалён",
  "promoSlides.delete.error": "Не удалось удалить слайд",
  "promoSlides.delete.confirmTitle": "Удалить слайд?",
  "promoSlides.reorder.error": "Не удалось переместить слайд",
  "promoSlides.col.image": "Фото",
  "promoSlides.col.title": "Название",
  "promoSlides.col.price": "Цена",
  "promoSlides.col.badge": "Бейдж",
  "promoSlides.col.active": "Активен",
  "promoSlides.col.actions": "Действия",
  "promoSlides.modal.createTitle": "Новый слайд",
  "promoSlides.modal.editTitle": "Редактирование слайда",
  "promoSlides.form.title": "Заголовок",
  "promoSlides.form.title.required": "Укажите заголовок",
  "promoSlides.form.description": "Описание",
  "promoSlides.form.price": "Цена",
  "promoSlides.form.oldPrice": "Старая цена",
  "promoSlides.form.badge": "Бейдж",
  "promoSlides.form.image": "Изображение",
  "promoSlides.form.color": "Градиент (Tailwind)",
  "promoSlides.form.linkUrl": "Ссылка",
  "promoSlides.form.sortOrder": "Порядок",
  "promoSlides.form.isActive": "Активен",
  "promoSlides.form.features": "Особенности (фичи)",
  "promoSlides.form.feature.text": "Текст",
  "promoSlides.form.feature.href": "Ссылка (необяз.)",
  "promoSlides.form.feature.add": "Добавить фичу",
};

export const ukPromoSlides: I18nDict = {
  "layout.menu.promoSlides": "Акції (слайдер)",
  "promoSlides.pageTitle": "Акційні пропозиції",
  "promoSlides.loadError": "Не вдалося завантажити слайди",
  "promoSlides.actions.create": "Додати слайд",
  "promoSlides.save.success": "Слайд збережено",
  "promoSlides.save.error": "Не вдалося зберегти слайд",
  "promoSlides.delete.success": "Слайд видалено",
  "promoSlides.delete.error": "Не вдалося видалити слайд",
  "promoSlides.delete.confirmTitle": "Видалити слайд?",
  "promoSlides.reorder.error": "Не вдалося перемістити слайд",
  "promoSlides.col.image": "Фото",
  "promoSlides.col.title": "Назва",
  "promoSlides.col.price": "Ціна",
  "promoSlides.col.badge": "Бейдж",
  "promoSlides.col.active": "Активний",
  "promoSlides.col.actions": "Дії",
  "promoSlides.modal.createTitle": "Новий слайд",
  "promoSlides.modal.editTitle": "Редагування слайда",
  "promoSlides.form.title": "Заголовок",
  "promoSlides.form.title.required": "Вкажіть заголовок",
  "promoSlides.form.description": "Опис",
  "promoSlides.form.price": "Ціна",
  "promoSlides.form.oldPrice": "Стара ціна",
  "promoSlides.form.badge": "Бейдж",
  "promoSlides.form.image": "Зображення",
  "promoSlides.form.color": "Градієнт (Tailwind)",
  "promoSlides.form.linkUrl": "Посилання",
  "promoSlides.form.sortOrder": "Порядок",
  "promoSlides.form.isActive": "Активний",
  "promoSlides.form.features": "Особливості (фічі)",
  "promoSlides.form.feature.text": "Текст",
  "promoSlides.form.feature.href": "Посилання (необов.)",
  "promoSlides.form.feature.add": "Додати фічу",
};

Object.assign(ru, ruPromoSlides);
Object.assign(uk, ukPromoSlides);
